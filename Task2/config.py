...
config.py
---------
Central configuration for Task 2. All hyperparameters and paths live here
so training scripts stay short and easy to read.
"""
...
A_EPOCHS         = 50
A_EARLY_STOP_PAT = 7
# histiocyte upweighted — rarest class in contrastive set and hardest to classify
A_CLASS_WEIGHTS  = [3.0, 1.0, 1.0]
